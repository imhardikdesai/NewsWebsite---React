...
export class News extends Component {
    ...
    async componentDidMount() {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5ee41684e9124d3382b0e5416bb89437&page=1&pageSize=${this.props.pageSize}`;
    ...
    btnPrev = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5ee41684e9124d3382b0e5416bb89437&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        let data = await fetch(url);
        let newData = await data.json();
        this.setState({
            articles: newData.articles,
